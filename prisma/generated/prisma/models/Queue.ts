...
export type QueueWhereInput = {
  ...
  created_at?: Prisma.DateTimeFilter<"Queue"> | Date | string
...
export type QueueScalarWhereWithAggregatesInput = {
  ...
  created_at?: Prisma.DateTimeWithAggregatesFilter<"Queue"> | Date | string
}
...
export type QueueOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"name" | "created_at", ExtArgs["result"]["queue"]>
...
export interface QueueDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const queueWithNameOnly = await prisma.queue.findMany({ select: { name: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Queues and only return the `name`
   * const queueWithNameOnly = await prisma.queue.createManyAndReturn({
   *   select: { name: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Queues and only return the `name`
   * const queueWithNameOnly = await prisma.queue.updateManyAndReturn({
   *   select: { name: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface QueueFieldRefs {
  ...
  readonly created_at: Prisma.FieldRef<"Queue", 'DateTime'>
}
